...
func (h *Handler) init() {
	...
	mux.HandleFunc("GET /chats", h.showChats)
	mux.HandleFunc("GET /chats/redirect", h.chatRedirect)
	mux.HandleFunc("GET /chats/new", h.showCreateChat)
	mux.HandleFunc("POST /chats", h.createChat)
	mux.HandleFunc("GET /chats/{chatID}", h.showChat)
